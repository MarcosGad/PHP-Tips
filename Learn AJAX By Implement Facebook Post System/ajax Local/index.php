  ...
  <div class="container">
    ...
    <div id="modal1" class="modal">
        <div class="modal-content">
            <form>
               ...
               <input type="hidden" id="post-id"> <!-- aly f id  -->
           </form>
        </div>
    ...
    <script>
    	  ...
    	  $(document).ready(function(){
            ...
            /*
            $(".edit").click(function(){
                $('#modal1').modal('open'); // msht9lsh 3ashn al class mash f al page 3ashn kd ast5dmta (on)
            })
            */

            $("#posts-container").on("click",".edit", function(){
                $('#modal1').modal('open');
                $("#post-id").val($(this).data("id")); // aly mogod f al input al m5faa
      ...
      function post(reqType, id){
          ...
          if(reqType == undefined && id == undefined){
              ...
              reqType = ''; // lo al fun mafhasg prmiter
              id = ''; 

          }else if(reqType == 'add'){

              id = ''; // dont use in delete
          }else if(reqType == 'del'){
