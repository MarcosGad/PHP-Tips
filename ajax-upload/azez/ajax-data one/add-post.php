		...
		<div class="panel-body">	
		  	<form class="form-rtl has-validation-callback" method="post" action="" id="form-add-post" enctype="multipart/form-data">
					...
					<div class="row form-group">
						...
						<div class="col-sm-10">
							  <input type="text" class="form-control" id="post_name" name="post_name" autocomplete="off" data-validation="required" data-validation-error-msg="برجاء أدخال اسم الزوجة" placeholder="اسم الزوجة" >
						</div>
				    </div>	
					...
					<label for="post_namehusband" class="col-sm-2 control-label">أسم الزوج</label>
						<div class="col-sm-10">
							  <input type="text" class="form-control" id="post_namehusband" name="post_namehusband" data-validation="required" data-validation-error-msg="برجاء ادخل اسم الزوج"  autocomplete="off" placeholder="أسم الزوج" >
						</div>
				    </div>	
